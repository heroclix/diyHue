...
def on_autodiscovery_light(msg):
    ...
    for key, data in discoveredDevices.items():
        ...
        if device_new:
            ...
            # Device capabilities
            keys = data.keys()
            light_color = "color_mode" in keys and data["color_mode"] == True and "xy" in data["supported_color_modes"]
            light_brightness = "brightness" in keys and data["brightness"] == True
            light_ct = "color_mode" in keys and data["color_mode"] == True and "color_temp" in data["supported_color_modes"]
